#Multimodal LSTM-CNN Based Approach to Audiovisual Emotion Recognition
#Overview

This project presents a multimodal deep learning framework for emotion recognition using both facial expressions and speech signals. By combining Convolutional Neural Networks (CNNs) for visual feature extraction and Long Short-Term Memory (LSTM) networks for audio sequence modeling, the system captures complementary emotional cues from multiple modalities.
...
│
├── FINAL_Code.ipynb
├── Dissertation_Research paper_Final.pdf
├── README.md
├── datasets/
└── results/
